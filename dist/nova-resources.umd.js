...
// CONCATENATED MODULE: ./src/Component.vue?vue&type=template&id=6c959fe8&
  ...
  methods: {
    ...
    checkNewProjectCruds: function checkNewProjectCruds() {
      ...
      this.projectCruds.forEach(function (crud) {
        ...
        _this2.$set(_this2.pluginData.cruds, crud.id, crudData);
      });
      this.save();
    },
